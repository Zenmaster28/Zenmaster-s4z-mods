...
export class SauceElevationProfile {
    ...
    constructor(options) {
        ...
        this.el = options.el;
        this.worldList = options.worldList;
        this.preferRoute = options.preferRoute;
        this.showMaxLine = options.showMaxLine;
        this.showCurrentAltitude = options.showCurrentAltitude;
        this.showRouteMaxElevation = options.showRouteMaxElevation;
        this.disablePenRouting = options.disablePenRouting;
        ...
        this.showLeaderSweep = options.showLeaderSweep;
        this.showGroups = options.showGroups;
        this.showNextPowerup = options.showNextPowerup;
        this.groups = [];
        this.colorScheme = options.colorScheme;
        this.gradientOpacity = options.gradientOpacity;
        this.lineTextColor = options.lineTextColor;
        this.currentLap = -1;
        this.lapCounter = 0;
        this.watchingTeam = "";
        this.watchingPosition = 0;
        this.showSegmentStart = options.showSegmentStart;  
        this.showSegmentFinish = options.showSegmentFinish;
        this.showAllArches = options.showAllArches;
        this.minSegmentLength = options.minSegmentLength;
        this.showLoopSegments = options.showLoopSegments;
        this.showNextSegment = options.showNextSegment;
        this.showNextSegmentFinish = options.showNextSegmentFinish;
        this.lineType = options.lineType;
        this.lineTypeFinish = options.lineTypeFinish;
        this.lineSize = options.lineSize;
        this.invertSegmentBool = options.invertSegmentBool;
        this.pinSize = options.pinSize;
        ...
        this.showMyPin = options.showMyPin;
        this.setAthleteSegmentData = options.setAthleteSegmentData;
        ...
        this.overrideDistance = options.overrideDistance;
        this.overrideLaps = options.overrideLaps;
        this.customDistance = 0;
        this.customFinishLine;
        this.yAxisMin = options.yAxisMin;
        this.singleLapView = options.singleLapView;
        this.profileZoom = options.profileZoom;
        this.zoomNextSegment = options.zoomNextSegment;
        this.zoomSegmentOnlyWithinApproach = options.zoomSegmentOnlyWithinApproach;
        this.zoomedIn = false;
        this.zoomNextSegmentApproach = options.zoomNextSegmentApproach;
        this.zoomFinalKm = options.zoomFinalKm;
        this.zoomSlider = options.zoomSlider;
        this.zoomRemainingRoute = options.zoomRemainingRoute;
        this.zoomIdx = {
            start: null,
            finish: null
        };
        this.forwardDistance = options.forwardDistance;
        this.behindDistance = options.behindDistance;
        this.refresh = options.refresh;
        this._lastRender = 0;
        this._refreshTimeout = null; 
        this.customPOI = [];
        this.editedSegments = []; 
        this.showLineAhead = options.showLineAhead;
        this.distanceAhead = options.distanceAhead;
        this.aheadLineColor = options.aheadLineColor;
        this.aheadLineType = options.aheadLineType;
        this.showXaxis = options.showXaxis;  
        this.xAxisInverse = options.xAxisInverse;
        this.xAxisIncrements = options.xAxisIncrements; 
        this.courseRoads = [];   
        this.portalRoads = [];
                    ...
                    data: marks.map(({state}) => {                                        
                        ...
                        if ((this.showMyPin && isWatching) || 
                            ...
                            if (state.eventSubgroupId > 0 && this.colorPinsByCat && this.eventInfo?.cullingType == "CULLING_EVENT_ONLY") {
                                const stateSg = this.eventInfo.eventSubgroups.find(x => x.id == state.eventSubgroupId);
                                eventCategory = stateSg?.subgroupLabel;
                                if (eventCategory) {
                                    eventCatColor = this.catColors[eventCategory];
                                    if (eventCatColor) {
                                        useEventCatColor = true;
                                    }
                                }
                            }
